...
<div class="logo-slaider-wrap">
	<div class="logo-slaider-items">
		<a href="https://chicago.kiev.ua/" target="_blank" class="logo-link">
			<?php include('img/logos/chicago.svg'); ?>
		</a>
	</div>
	<!-- /.logo-slaider-items -->
	<div class="logo-slaider-items">
		<a href="https://kandinsky-residence.com.ua/" target="_blank" class="logo-link">
			<?php include('img/logos/kandinsky.svg'); ?>
		</a>
	</div>
	<!-- /.logo-slaider-items -->
	<div class="logo-slaider-items">
		<a href="https://sanfrancisco.com.ua/ru/" target="_blank" class="logo-link">
			<?php include('img/logos/sf.svg'); ?>
		</a>
	</div>
	<!-- /.logo-slaider-items -->
	<div class="logo-slaider-items">
		<a href="https://resident.house/" target="_blank" class="logo-link">
			<?php include('img/logos/resident.svg'); ?>
		</a>
	</div>
	<!-- /.logo-slaider-items -->
	<div class="logo-slaider-items">
		<a href="http://new-york.com.ua/ru/" target="_blank" class="logo-link">
			<?php include('img/logos/nework.svg'); ?>
		</a>
	</div>
	<!-- /.logo-slaider-items -->
	<div class="logo-slaider-items">
		<a href="https://bristol.house/ru/" target="_blank" class="logo-link">
